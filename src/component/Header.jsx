...
const Header = ({ lang, locale, setLocale }) => {
  ...
  return (
    <Box sx={{ width: "100%", bgcolor: "background.paper" }}>
      ...
      <Dropdown nav isOpen={dropdownOpen1} toggle={()=>toggle('dropdownOpen1')}>
      ...
      <Dropdown nav isOpen={dropdownOpen2} toggle={()=>toggle('dropdownOpen2')}>
        <DropdownToggle nav caret>
      ...
      <NavItem>
        <NavLink href="#"> <FormattedMessage id="locales.sustainability.text" /></NavLink>
      </NavItem>
      <Dropdown nav isOpen={dropdownOpen3} toggle={()=>toggle('dropdownOpen3')}>
        <DropdownToggle nav caret>
